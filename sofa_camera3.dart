...
class SofaAILensScreen3 extends StatefulWidget {
  final String imagePath;
  final Uint8List? imageBytes;

  SofaAILensScreen3({required this.imagePath, this.imageBytes});

  @override
  _AILensScreenState createState() => _AILensScreenState();
}

class _AILensScreenState extends State<SofaAILensScreen3> {
        ...
        children: [
          Container(
            ...
            child: Padding(
              ...
              child: IconButton(
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const SofaArScreen3()));
                },
          ...
          Expanded(
              child: SizedBox(
                ...
                child: ModelViewer(src: "assets/ar_model/victorian_lounge_sofa.glb",autoRotate: true,),
              ),
            ),
