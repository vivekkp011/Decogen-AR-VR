...
class AILensScreen3 extends StatefulWidget {
  final String imagePath;
  final Uint8List? imageBytes;

  AILensScreen3({required this.imagePath, this.imageBytes});

  @override
  _AILensScreenState createState() => _AILensScreenState();
}

class _AILensScreenState extends State<AILensScreen3> {
  List<Map<String, String>> recommendations = [];
  bool isLoading = true;
        ...
        children: [
          Container(
            ...
            child: Padding(
              ...
              child: IconButton(
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => ArScreen3()));
                },
          ...
          Expanded(
              ...
              child: SizedBox(
                ...
                width: double.infinity,
                child: ModelViewer(src: "assets/ar_model/office_chair.glb"),
)
            ),
