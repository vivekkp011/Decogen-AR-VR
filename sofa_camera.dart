...
class SofaAILensScreen extends StatefulWidget {
  final String imagePath;
  final Uint8List? imageBytes;

  SofaAILensScreen({required this.imagePath, this.imageBytes});

  @override
  _AILensScreenState createState() => _AILensScreenState();
}

class _AILensScreenState extends State<SofaAILensScreen> {
        ...
        children: [
          Container(
            ...
            child: Padding(
              ...
              child: IconButton(
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => SofaArScreen()));
                },
          ...
          Expanded(
              ...
              child: SizedBox(
                ...
                child: ModelViewer(src: "assets/ar_model/sofa.glb",autoRotate: true,),
              ),
            ),
