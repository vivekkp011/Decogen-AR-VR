...
class AILensScreen4 extends StatefulWidget {
  final String imagePath;
  final Uint8List? imageBytes;

  AILensScreen4({required this.imagePath, this.imageBytes});

  @override
  _AILensScreenState createState() => _AILensScreenState();
}

class _AILensScreenState extends State<AILensScreen4> {
  List<Map<String, String>> recommendations = [];
  bool isLoading = true;
        ...
        children: [
          Container(
            ...
            child: Padding(
              ...
              child: IconButton(
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => ArScreen4()));
                },
          ...
          Expanded(
              ...
              child: SizedBox(
                ...
                width: double.infinity,
                child: ModelViewer(src: "assets/ar_model/basket_swing_chair.glb"),
)
            ),
