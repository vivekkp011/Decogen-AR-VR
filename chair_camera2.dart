...
class AILensScreen2 extends StatefulWidget {
  final String imagePath;
  final Uint8List? imageBytes;

  AILensScreen2({required this.imagePath, this.imageBytes});

  @override
  _AILensScreenState createState() => _AILensScreenState();
}

class _AILensScreenState extends State<AILensScreen2> {
  List<Map<String, String>> recommendations = [];
  bool isLoading = true;
        ...
        children: [
          Container(
            ...
            child: Padding(
              ...
              child: IconButton(
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => ArScreen2()));
                },
          ...
          Expanded(
              ...
              child: SizedBox(
                ...
                width: double.infinity,
                child: ModelViewer(src: "assets/ar_model/dublin_chair.glb"),
)
            ),
